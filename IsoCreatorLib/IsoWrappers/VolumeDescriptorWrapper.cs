...
namespace IsoCreatorLib.IsoWrappers
{
    internal class VolumeDescriptorWrapper
    {
        ...
        public VolumeType VolumeDescriptorType
        {
            ...
            set
            {
                if (m_volumeDescriptorType != value &&
                    ...
                    value == VolumeType.Suplementary) && m_volumeDescriptor != null)
                {
                                          ...
                                          AsciiDateRecord expirationDate, AsciiDateRecord effectiveDate)
        {
            ...
            m_rootDirRecord = new DirectoryRecordWrapper(m_volumeDescriptor.RootDirRecord = rootDirRecord);
            m_creationDate = new DateWrapper(m_volumeDescriptor.CreationDate = creationDate);
            m_modificationDate = new DateWrapper(m_volumeDescriptor.ModificationDate = modificationDate);
            m_expirationDate = new DateWrapper(m_volumeDescriptor.ExpirationDate = expirationDate);
            m_effectiveDate = new DateWrapper(m_volumeDescriptor.EffectiveDate = effectiveDate);
        }
                                          ...
                                          AsciiDateRecord expirationDate, AsciiDateRecord effectiveDate)
        {
            ...
            SetVolumeDescriptor(systemId, volumeId, volumeSpaceSize, pathTableSize, typeLPathTable, typeMPathTable,
        ...
        {
            if (m_volumeDescriptor == null) return 0;
